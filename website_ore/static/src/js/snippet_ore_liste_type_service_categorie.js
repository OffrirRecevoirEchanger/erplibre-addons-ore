odoo.define(
    "ore_liste_type_service_categorie.animation",
    function (require) {
        "use strict";

        let sAnimation = require("website.content.snippets.animation");

        sAnimation.registry.ore_liste_type_service_categorie =
            sAnimation.Class.extend({
                selector:
                    ".o_ore_liste_type_service_categorie",
                ...
                start: function () {
                    ...
                    let def = this._rpc({
                        route: "/ore/type_service_categorie_list",
                    }).then(function (data) {
                        if (data.error) {
                            return;
                        }
