odoo.define('website.ore.debug_not_implemented.instance', function (require) {
    'use strict';

    require('web_editor.ready');
    let Debug = require('website.ore.debug_not_implemented');
...
odoo.define("website.ore.debug_not_implemented", function (require) {
    ...
    let Debug = Widget.extend({
        ...
        LoadCss: function (isLoad, uniqueIdName, cssName) {
            if (isLoad) {
                ...
                link.href = document.location.origin + "/website_ore/static/src/scss/" + cssName;
