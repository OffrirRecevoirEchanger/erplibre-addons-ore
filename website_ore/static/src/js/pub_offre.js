odoo.define('website.ore.pub_offre.instance', function (require) {
    'use strict';

    require('web_editor.ready');
    let PublierForm = require('website.ore.pub_offre');
...
odoo.define("website.ore.pub_offre", function (require) {
