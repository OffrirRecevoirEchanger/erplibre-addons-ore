odoo.define('website.ore.navbar_tabs.instance', function (require) {
    'use strict';

    require('web_editor.ready');
    let PublierForm = require('website.ore.navbar_tabs');
...
odoo.define("website.ore.navbar_tabs", function (require) {
