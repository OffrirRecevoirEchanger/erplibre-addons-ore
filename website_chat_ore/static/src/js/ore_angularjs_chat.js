odoo.define('website.ore_angularjs_chat', function (require) {
    "use strict";

    require('web.dom_ready');
    require('bus.BusService');
    require('website.ore_angularjs_global');
    require('website.ore_notification');
    ...
    let OREAngularJSChat = Widget.extend({
        ...
        start: function () {
            ...
            this.call('bus_service', 'addChannel', "ore.notification.message");
    ...
    return {
        OREAngularJSChat: OREAngularJSChat,
    };
